...
*> \verbatim
*>
*> RTRTRI computes the inverse of a real upper or lower triangular
*> matrix A.
*>
...
*        Use unblocked code
*
         CALL RTRTI2( UPLO, DIAG, N, A, LDA, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               CALL RTRTI2( 'Upper', DIAG, JB, A( J, J ), LDA, INFO )
   20       CONTINUE
         ELSE
*
...
*              Compute inverse of current diagonal block
*
               CALL RTRTI2( 'Lower', DIAG, JB, A( J, J ), LDA, INFO )
   30       CONTINUE
         END IF
      END IF
*
