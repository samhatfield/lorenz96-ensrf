...
*> \verbatim
*>
*> RGETRI computes the inverse of a matrix using the LU factorization
*> computed by DGETRF.
*>
...
*
      CALL RTRTRI( 'Upper', 'Non-unit', N, A, LDA, INFO )
      IF( INFO.GT.0 )
     $   RETURN
*
      NBMIN = 2
      ...
      IF( NB.GT.1 .AND. NB.LT.N ) THEN
         ...
         IF( LWORK.LT.IWS ) THEN
            NB = LWORK / LDWORK
            NBMIN = MAX( 2, ILAENV( 2, 'RGETRI', ' ', N, -1, -1, -1 ) )
         END IF
      ELSE
         IWS = N
      END IF
