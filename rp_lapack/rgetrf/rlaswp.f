*> \brief \b RLASWP performs a series of row interchanges on a general rectangular matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE RLASWP( N, A, LDA, K1, K2, IPIV, INCX )
* 
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> RLASWP performs a series of row interchanges on the matrix A.
